...
ci_db = {'ENGINE': "django.db.backends.postgresql_psycopg2",
         'NAME': os.getenv("CI_DATABASE_NAME"), 'USER': os.getenv("CI_DATABASE_USER"),
         'HOST': os.getenv("CI_DATABASE_HOST")}


DATABASES = {
    "default": ci_db if os.getenv('CI_DATABASE_NAME') else local_test_db
}
